	...
	- 界面基本组件
	  collapsed:: true
		- TextView/Image View
			...
			- ```java
			  <TextView
			  	android:id="@+id/textView1" //textView的文字可以动态改变，可以显示调试信息
			      android:layout_width="match_parent"
			      android:layout_height="wrap_content" //内容决定高度
			      android:textColor="#ff0000"
			      android:textStyle="20sp" //不用管sp
			...
			- ```java
			  <ImageView
			  	android:id="@+id/imageView" //+是创建，之前没有的
			      adnroid:scaleType="缩放类型"
			      android:src="@"//之前就有
			  ```
			- 前面要有强制类型转换
			- ```java
			  ImageView iv=(ImageView)findViewById(R.id.imageView);
			  iv.setImageResource(R.drawable.bg320_480);//gradle解析
