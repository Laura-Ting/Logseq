...
- ## Topic
		...
		- 1，资助科研
			- Governments should place few, if any, restrictions on scientific research and development.
				- specific circumstances - advantageous or not
					- 促进解决短期社会问题，有利，eg COVID-19，vaccine
					- 促进长期科学发展，有利，eg 自动驾驶
					- 带来严重的未知性和风险性，核能，基因修改
			  ...
			  collapsed:: true
				- the possible consequences
				  collapsed:: true
					...
					- 同意：投入资金的时候需要考虑对人的影响，这种做法能避免人类走向灭绝，eg核能和修改基因
				- specific circumstances - advantageous or not
				  collapsed:: true
		...
		- 2，资助教育
		  collapsed:: true
			- Governments should offer college and university education free of charge to all students.
			  id:: 659b6ecf-5ab7-47ed-8d6f-e915148da367
			  collapsed:: true
				- specific circumstances
				  collapsed:: true
					- 不同意，只帮助需要的人
					- 社会，实现平等的教育机会，希望进行经济转型和创新的国家
					  collapsed:: true
		  ...
		  collapsed:: true
			- Governments should focus on solving the immediate problems of today rather than on trying to solve the anticipated problems of the future.
			  collapsed:: true
				- specific circumstances
				  collapsed:: true
					- 当下问题可以得到有效解决，当今社会面临许多紧迫的问题，例如经济不稳定和社会不平等等。政府确实需要集中力量解决这些当下问题，以确保公民的福祉和社会的稳定。
						- 因为这些直接影响人们的生活质量。
					  ...
					  collapsed:: true
						...
						- 反对：媒体在一定程度上让英雄变多了：因为传播作用
						  collapsed:: true
							...
							- 战士守卫边疆，战争，守护祖国的和平，每一个战士都是英雄
							- 社会世界：有些人拯救了苍生，媒体不说，人们不知道。例子：屠呦呦是个中国人，但是却是世界英雄，对所有国家都有影响。
			...
			- 11，社会特点看英雄特点
			  collapsed:: true
				- The best way to understand the character of a society is to examine the character of the men and women that the society chooses as its heroes or its role models.
					- challenge your position—把那段事实描述说成敌方观点
					  collapsed:: true
						- can not fully agree
						- 反驳：政治，不能代表所有人
						  collapsed:: true
				  ...
				  collapsed:: true
					...
					- 本专业已经是最好的专业了，出去就没有必要了，国外也不一定有那个环境。还要处理学分问题，课程一致性问题
					  collapsed:: true
						...
						- 在国内的：eg学习古汉语确实可能需要在中国进行，因为那里提供了更丰富的语言环境和文化背景。在中国学习古汉语可以让学生接触到原汁原味的语言使用情境和相关文化传统，这对于深入理解和掌握古代汉语是非常有帮助的。
		  ...
		  collapsed:: true
			...
			- 因为有热情，有更深的观察
			  collapsed:: true
				...
				- 艺术家Vincent van Gogh对于平凡的乡村风景充满了狂热的热情。他通过对麦田、星空等常见元素的深入观察，创作出了一系列具有深远影响的艺术作品。这些作品之所以能够引起共鸣，正是因为他对寻常事物的热情和深刻观察。
			- 反驳：并不是必要条件
			  collapsed:: true
				- 需要有相应的学识知识作为基础，并为之努力
				- 在艺术领域，存在一些例子表明即使充满热情，缺乏相关学识知识也可能导致失败。一位业余画家可能对绘画充满激情，但如果缺乏对色彩理论、构图技巧等基础知识的了解，其作品可能无法达到专业水平。这种情况可能阻碍了艺术家在艺术领域的发展，尽管充满热情，但缺乏学识支持可能成为制约因素。
				- 14世纪末，明朝一勇敢者万户坐在装有47个当时最大的火箭的椅子上，双手各持一大风筝，试图借助火箭的推力和风筝的升力实现飞行的梦想。尽管这次试验是一次失败的悲剧。
			- 反驳：也可以不是commonplace，比如尖端的科技难题
			  collapsed:: true
				- 企业家埃隆·马斯克对太空探索的热情推动了他创办SpaceX公司。虽然太空探索并非寻常事物，但他的热情驱使他深入研究航空航天领域，挑战尖端科技难题，最终取得了许多创新性的成果。这表明创意也可以来自对非寻常事物的专注。
	- 33，保护濒危物种 P79
		- 只保护人类行为引起的濒危物种
		  collapsed:: true
			  ...
			  collapsed:: true
				- the possible consequences
				  collapsed:: true
					...
					- 对社会，有人说节省人力财力，保护所有濒危物种需要庞大的资源，而这些资源可能在其他紧急问题上更为紧缺，比如人类社会面临的健康、贫困和教育等问题。基因多样性的损失无法弥补（但是，我们可以通过旅游业创造的经济收益来保证这些紧急问题。）
	...
	- 34，更加可理解还是复杂
	  collapsed:: true
		...
		- 科学发现让我们更加理解还是更加复杂
		  collapsed:: true
			- Some people believe that scientific discoveries have given us a much better understanding of the world around us. Others believe that science has revealed to us that the world is infinitely more complex than we ever realized. 同上一个题
	- 35，有对立才有进步 P97
		- 对立or合作
		  collapsed:: true
				  ...
				  collapsed:: true
					...
					- 自然科学领域创新和批判性思维：
					  collapsed:: true
						...
						- 在科学研究中，对比不同的假设和理论是推动科学进步的关键。例如，关于地球的形状（shape of the earth）、宇宙的起源（the origin of the universe）或者气候变化（climate change）的讨论，科学家们通过对比不同观点来推动知识的发展。
					- 社会科学上更全面的（政治）决策：
					  collapsed:: true
			...
			- Claim: We can usually learn much more from people whose views we share than from those whose views contradict our own.
			  ...
			  Reason: Disagreement can cause stress and inhibit learning.
				...
				- 反驳reason：不一致有时确实引起压力和阻碍学习，但是也不意味着就没有好处，+科学中反驳，修正，前进，比如地球的形状
		- 挣扎在限制中比成功学到的更多
		  collapsed:: true
				  ...
				  collapsed:: true
					...
					- 同意，对年轻人个人：
					  collapsed:: true
						...
						- 追求长期目标可以为个人提供更为稳定和持久的成就感。较短期的名誉可能是瞬间的，而长期努力所带来的成就感更为深厚。
						- 长期目标往往需要不断学习和提升自己。这种过程促使个人保持好奇心，持续学习，不断成长。
					...
					- 同意，对社会：
					  collapsed:: true
						...
						- 追求长期目标的个人往往更注重社会责任感。他们可能更倾向于参与社会事务，为社会做出有益的贡献。比如说环保和社会公益项目
						- 追逐即时名誉可能助长浮躁文化，而鼓励年轻人追求长期目标有助于减缓这种文化，培养更为深厚的价值观。
						- eg阿波罗登月计划是美国在20世纪60年代推动的一项宇航计划，旨在实现人类登陆月球的目标。年轻的科学家和工程师在这个过程中发挥了重要作用，为社会带来了许多技术的突破和进步。有年轻科学家致力于长期科研项目，解决特定领域的难题，推动科学技术的进步，为社会带来新的知识和技术。
					- 指出需要注意：
					  collapsed:: true
				  ...
				  collapsed:: true
					...
					- 对社会：
					  collapsed:: true
						...
						- 社会变革：在社会变革和政治运动中，一些人可能会认为通过采取激进手段来推动社会正义和平等是正当的。例如，历史上有些社会运动可能采取了非常激进的手段来争取权益和改革。
						- eg美国民权运动，马丁路德金
					- 让步：
					  collapsed:: true
						- 但是要合法合理，比如抢劫。
				...
				- ways
				  collapsed:: true
					...
					- 反驳claim：吸取过去成功和失败的经验，避免重蹈覆辙，为现代的决策提供有益参考。
					  collapsed:: true
						- eg 希特勒发动二战的历史事件为我们提供了深刻的教训和有益的参考。这一行为导致了数以百万计的生命丧失以及全球范围内的破坏，彰显了单方面追求扩张和霸权的危险性。通过反思这段黑暗历史，现代决策者应该警惕民族主义和仇恨煽动的危害，并牢记国际法律和合作精神的重要性，以避免再次重蹈覆辙，塑造和维护和平稳定的国际秩序。
					- 反驳claim：过去已经形成的状态和局面是当今的基础。没有过去就没有当今的决策，了解过去帮助我们了解当今局面形成的原因。
					  collapsed:: true
						...
						- eg中国大陆和台湾问题是一个长期存在的复杂争议，涉及领土、宗教、历史和民族认同等多个层面。对于实现和平稳定的解决方案必须要考虑促使这个问题形成的很多因素，目前仍然存在挑战。
		  ...
		  collapsed:: true
			- Claim: Though often considered an objective pursuit, learning about the historical past requires creativity.
			  ...
			  Reason: Because we can never know the past directly, we must reconstruct it by imaginatively interpreting historical accounts, documents, and artifacts.
				...
				- 反驳reason，历史可以被直接了解，客观历史记录，许多史料，真实视频记载，重现当时的情景。 1969年阿波罗11号登月任务。登月时刻被摄像机记录下来，观众可以清晰地看到宇航员首次踏上月球的场景。历史学家还依靠放射性碳radiocarbon测年来计算所发现的旧物体的年龄。在对所有这些进行详细研究之后，历史学家得出了一个特定的结论。
				- 如果能直接了解到这个历史事实那么我们为什么还需要creativity。是因为我们不了解当时发生的细节，发生这件事时宇航员是怎么想的。然而，这些视频记录只能展示任务的部分过程，人们需要通过想象力来还原整个任务的细节和背后的情景，比如宇航员在太空中的生活、对家乡的思念以及历史性时刻带来的情感体验等。这些视频记录激发了人们对太空探索、科学发现以及人类对未知世界的好奇心，同时也引发了无数对于登月任务的想象和猜测。同样，用radiocarbon探测出所属时代的古物，人们也需要猜测他是用来做什么的，产生的过程等等。
				- 另一个值得注意的问题就是，历史从不是一种客观追求，客观的历史证据只是一部分，当历史学家诠释和撰写档案记录时，却参杂着自己的情感和喜好的。再客观也无法避免人的主观因素。eg英国巨石阵是位于英格兰的一处史前遗迹，由立起的巨大石块组成。它很可能与古代居民的宗教信仰、天文学知识和社会活动有关。然而，对于巨石阵的目的和意义，以及建造者的身份等问题，依然存在许多不同的看法和假设。因此，对于这样的史前遗迹，历史学家和考古学家的主观解释和推断确实会影响到我们对其的理解。
		- 43，没有过去的相同领域的成就无法伟大成就 P53
		  collapsed:: true
			- In any field of endeavor, it is impossible to make a significant contribution without first being strongly influenced by past achievements within that field.——ways
				...
				- 除外：除了全新领域，史无前例，
				  collapsed:: true
					- eg人工智能和机器人跨专业领域
					- 再eg自动驾驶，一开始人们都觉得这是个天方夜谭，人们可能对于让车辆自动驾驶而不由人类驾驶员控制的概念感到不安。由于这是一个全新的领域，科研人员没有过去的经验可以借鉴，只能在全新的传感技术、人工智能算法以及硬件设备的情况下创新和探索。但是我们现在已经有所成就并且在一些城市和地区已经启动了自动驾驶汽车的试点项目。
				...
				- 在艺术领域看似是创新：
				  collapsed:: true
					- 毕加索在巴黎参观了民族学博物馆，看到了非洲和印第安艺术的展品。这些艺术品的非传统形式、几何化的表现和对多视角的运用对毕加索产生了深远的影响。他从这些文化中汲取灵感，将其融入自己的创作中，形成了立体主义风格的奠基
	- 44，考虑后果后再冒险 P102
	  collapsed:: true
				...
				- ways
				  collapsed:: true
					...
					- 需求创造了政治领域的领袖
					  collapsed:: true
						- 如果人们不想进行社会改革，就不会有政治家和革命家的出现
						- 马丁路德金，如果当时的黑人不想改变自己的社会地位，就不会有leader来引领。在美国历史上，黑人社群一直面临着严重的社会压迫和歧视。这些压力激发了对提升自身社会地位的强烈需求，以摆脱长期以来对其平等权利的剥夺。在这种环境下，出现了杰出的领导者，如马丁·路德·金，他们通过非暴力手段和公民抗议，努力满足社会中被忽视的需求。
					- 让步
					  collapsed:: true
						- 但是光有需求也是不够的，leaders还需要具备满足这些要求的能力和素养
						- 黑人这个地位一直不高，提升黑人地位这个诉求也是从一开始就存在的，但是直到曼德拉的出现才去的进展，是因为前面的人的leadership，public speak的能力不够，没有办法来团结更多的黑人
						- 需求不是decisive factor，但是也特别特别重要
		- 46，领导人要维持最高的道德标准 P88
		  collapsed:: true
				...
				- challenge your position.
				  ...
				  collapsed:: true
					- 承认领导人要有良好的道德和道德标准
					  collapsed:: true
						- 因为他/她将在世界面前代表整个国家。
						- 最重要的是，领导者为后代和下属树立了榜样
						- eg以中国反腐败运动为例，中国政府自2012年开始进行了一场大规模的反腐败斗争。这场斗争涵盖了各个层面的官员，包括中央和地方政府、国有企业等，旨在清除腐败分子，恢复政府的公信力，提高社会的透明度和效率。这个例子显示了领导者通过坚决的行动来维护道德和伦理标准
					- 但是道德标准不是必要的评判条件
					  collapsed:: true
						- 没有最高的道德标准我们也不能认为这个领导人就有效，勇气和强大的决策能力，民主
						- eg理查德·尼克松为例。尽管他因20世纪美国最臭名昭著的丑闻“水门事件”而被迫辞职，但许多美国人仍然认为他是一位有效和成功的总统，因为他为停止越南战争和改善与中国和苏联的关系所做的努力。总而言之，我们应该根据领导者的实际价值来公平地评估他的有效性，即使他或她做了一些不道德的事情。
						- 有最高的道德标准也有可能没有效，
						- eg吉米·卡特（Jimmy Carter）美国前总统，被广泛认为是一位道德标准高的领导者，但他的部分决策和政策在其任期内遭到了批评，并被视为导致效率低下和经济问题。
					- 可行性：实际上道德标准在每个地方都是不同的
					  collapsed:: true
						- 此外，由于文化多样性，这个世界上没有人能够澄清“最高”道德标准的定义。从某种意义上说，道德只是个人判断的问题。许多道德的事情如果发生在另一个地方，就会被认为是不道德的，而一个人认为适当的事情在另一个人眼中可能是冒犯性的。为了说明这一观点，我们可以看看西方和东方之间的区别。在中国、日本或韩国等东方国家，说话时直视眼睛可能非常粗鲁，而在西方国家却很常见。更有趣的是，在那些东方国家，根据道德标准，孩子不应该有任何父母的名字，但西方人往往与他们的父亲同名以纪念他们。从这些例子中可以明显看出，可能根本没有可以普遍接受的最高道德标准。eg例如，在印度，由于宗教和文化原因，牛被视为神圣的动物，因此食用牛肉在该国的许多地区是被禁止的。然而，在其他地方，食用牛肉可能是正常的饮食选择。
				- ways
				  background-color:: yellow
		- 47，领导人5年换届 P117
		  collapsed:: true
			  ...
			  collapsed:: true
				...
				- the possible consequences
				  collapsed:: true
					- 承认好处：
					  collapsed:: true
						- 5年换届对leaders好，促进民主政治：民主和权力制衡，避免权力过度集中和滥用
						  collapsed:: true
						...
						- 5年换届对society好
						  collapsed:: true
							- 可以极大地激发人们的工作效率，在各个领域获得更多的人才，使更多的问题得已解决。改革，新思想
							- eg国内公务员积极性不高，无论做多做少都那样，因为上面的人也会一干干到退休，没有强烈的意愿。换届激励更多人努力工作，得到promotion，社会得良性发展。如果有总统梦就可以为之努力，新人到领导岗位才容易产生new ideas
					- 需要年限长的领域，这个政策不好：
					  collapsed:: true
						- 但是个别领域进步比较慢，5年有些短，基础设施项目（修建高速公路、铁路、桥梁或隧道等大型交通基础设施项目）通常需要数年的时间来完成，需要协调各个部门和利益相关者的合作。。在这些项目中，领导者的连任能够确保项目的连贯性和长期规划，从而更有效地推动基础设施的发展。
					- 换届对领导人的影响：
						- 同时，需要考虑换届对领导人的影响，现任可能会消除前任的政策并且颁布自己新的政策，eg特朗普废除部分奥巴马医改，引发决策过程的反复，带来混乱。（Trump's repeal of parts of Obamacare has triggered a back-and-forth in the decision-making process and brought chaos.）同时五年的时间限定会对领导人的心态产生影响，目光短浅，更多考虑自己的利益。
				- claim-reason
				  collapsed:: true
			...
			- Any leader who is quickly and easily influenced by shifts in popular opinion will accomplish little.
			  collapsed:: true
				- ways
					- 坚持自己重要
					  collapsed:: true
						- 历史上的一些伟大领导者，如马丁·路德·金和尼尔森·曼德拉，都是坚定信念和价值观的拥护者。他们在追求民权和平等方面做出了持久的影响，而不是被瞬时的舆论所左右。
						- 企业界也有很多成功的领导者，他们能够坚定地遵循自己的愿景和战略，而不是频繁变换策略以适应市场的短期波动。比如史蒂夫·乔布斯对苹果公司的长期愿景和产品创新，以及亚马逊的杰夫·贝佐斯对于坚持长期投资和创新的执着。
					- 听从民意也很重要
					  collapsed:: true
						- 在商业界，一些成功的企业领导者能够根据市场反馈和消费者需求进行灵活调整，从而更好地满足市场需求。这种与市场环境的积极互动有助于企业长期发展。
						- 弗兰克林·德拉诺·罗斯福（Franklin D. Roosevelt），美国历史上的一位杰出领导者。在他执政期间，面对大萧条和二战等重大挑战，罗斯福表现出了对社会舆论的敏感和灵活应变能力。他能够积极地回应民意，并采取必要的改革措施来缓解经济危机，并在困难时期带领国家走出困境。
						- 尽管他被认为是一个坚定和果断的领导者，但他也向公众传达了一种与时俱进的领导风格，愿意倾听并回应人们的需求。这种对民意的敏锐感知使得他能够更好地实现自己的政策目标，并在困难时期保持了领导力和影响力。
					- 两者权衡，民意需要考虑，但是也不能简单的，快速的，无条件的接收。比如说，使用清洁能源和传统能源的问题，政府总体上要站在人们大众可持续发展的角度上
		- 49，合作还是竞争
		  collapsed:: true
				  ...
				  collapsed:: true
					- 科学研究领域：
					  collapsed:: true
						...
						- 科学家的严谨性：在任何一个例子中都要确保既有commitment又有criticality
						  科学界的例子是很合适的 因为卡尔波普提出过科学理论需要证伪
						  因此科学家自己重视的理论 一定会比较批判 会关注可能推翻这一理论的新数据
						- 科学家们必须证明一个理论的正确性，和这个理论正确的何时何种条件，举例：广义相对论是对侠义相对论的补充。
					- 同意，政治领袖自我批评：
					  collapsed:: true
					...
					- 同样是科学研究领域：后果，当科学不仅仅是科学
					  collapsed:: true
						- 对于核科学家来说，他们会对核研究非常挑剔，特别是为了破坏目的，但对于政治家和商人来说却不是这样。比如，“曼哈顿计划”，科学家和政治家及商人都是非常热心的，尤其是军人，但，自对日本使用了核弹之后，科学家态度变了，比如爱因斯坦，甚至都公开反对核武的研发了，但政治家核武研发政策依旧很热心，其无非是为了震慑潜在对手，而商业公司，则更是迫不及待的加速核武的研发，以便有更多的利润。现在的核废水也是这个道理。
					- 不排除：
					  collapsed:: true
						- 有些人可能对某个观念或政策深感承诺，但却表现出盲目信仰，不愿对其进行批判。这种情况下，深度承诺并不一定导致对所支持的观念的深刻批评，而可能导致对批评视而不见。可能会对与之相悖的观点产生偏见，导致不愿意或难以进行客观的批评。这种情况下，深度承诺反而可能阻碍了对观念的批评性思考。
						- eg在像绘画和舞蹈这样的艺术领域，欣赏一个想法的人通常是不挑剔的，因为艺术的精神是专注于创造力和个人的审美享受，这通常超过了一个想法的缺点或不完美。举例：印象派画作、梵高。
						- eg政客通常不会critical自己commit的政策 因为政客通常都要考虑自己的地位是否稳固，而且政敌会比较critical 最终会有一个平衡的结果
						- eg比如说一些宗教的信仰者
	- 52，青年与当今发展趋势
	  collapsed:: true
			...
			- ways
			  collapsed:: true
				...
				- 但是人们的选择，人们心中的价值观也是受到长期影响的
				  collapsed:: true
					- 祖祖辈辈传下来的价值观，
					- eg 在二战期间，有一些人选择宁死不屈，宁愿接受严刑拷打也不背叛自己的祖国。
					- eg二战期间，许多德国士兵拒绝执行纳粹政权对犹太人和其他少数群体的屠杀命令。这些士兵认为这些行为违反了基本的道德原则，因此他们拒绝参与屠杀活动，并有时候积极地寻求救助受害者。
					- 这些个体对人类尊严的尊重和对道德价值的坚守。
					- 禁止奴隶制度，因为这违背了对人类尊严和自由的基本价值观。奴隶制度剥夺了个体的自由和尊严，违反了现代社会对平等和人权的普遍认可。
				- 我们周围的环境会受社会影响
				  collapsed:: true
			...
			- In business, education, and government, it is always appropriate to remain skeptical of new leaders until those leaders show that they are worthy of trust.
				- challenge your position
				  collapsed:: true
					...
					- 反方大家不应该质疑，领导说的什么都对。新上任的领导会修改之前的问题，带来创新和正确的决定。但是事实是不可信的，比如说希特勒，引出对领导好，对社会好
					- 对领导好
					  ...
					  collapsed:: true
						...
						- 维持学习的专注度：
						  collapsed:: true
							...
							- 通过在线协作平台和工具，学者能够方便地与同行合作、分享研究成果，并参与国际性的学术讨论。这种全球性的互动有助于拓宽研究视野，促使学者更专注于全球性的学术前沿。eg github解决问题。GitHub是一个全球领先的基于云的软件开发平台，它在促进科技解决问题方面发挥了关键作用。GitHub为开发者提供了一个共享和协作的平台，使得成千上万的开发者能够共同合作解决问题。通过开源项目，全球范围内的人们可以共同改进代码，提出建议，共同推动创新。
					...
					- More methods
					  collapsed:: true
						...
						- eg除了文字和语音通信，科技还引入了更多的交流方式，如表情符号、贴图、语音消息等。这种多样性使得人们能够更富有创意地表达自己，增加了交流的趣味性。
						  collapsed:: true
							- emoticons, stickers, voice messages，creatively and makes communication more interesting.
						- 比如：Facebook，Twitter，Instagram，朋友圈，点赞，交朋友.eg Instagram已经成为全球最受欢迎的社交媒体之一，拥有数十亿的活跃用户。用户可以通过手机拍摄照片和录制视频，然后应用各种滤镜和编辑工具进行处理。这些媒体内容可以通过用户的个人资料分享，也可以与其他用户互动，如点赞、评论和分享。
					- Rebuttal（反驳）
					  collapsed:: true
		  ...
		  collapsed:: true
			- challenge your position.
			  collapsed:: true
				...
				- 借反方之口承认，人们的行为可以由自己来决定，人们有主观能动性和选择的权利，eg二战时期Second World War宁可被打死也不背叛祖国，是战士们自己的选择
		  ...
		  background-color:: red
			- ways
			  collapsed:: true
				- 同意，
				  collapsed:: true
					- 创新的源泉：不同学科之间的交叉合作可以带来新的思路和创新的机会。通过与其他领域的专家合作，我们可以将不同的观点、方法和技术结合起来，从而创造出新的解决方案和发现。
					- eg神经网络算法在计算机科学和人工智能领域发挥着重要作用。这些算法的设计受到了生物学中神经系统的启发，特别是大脑中神经元之间的连接和信息传递方式。通过借鉴神经系统的工作原理，研究人员开发出了人工神经网络算法，用于模拟和处理复杂的信息和模式识别任务。
				- 同意，
				  collapsed:: true
					- 解决复杂问题：现实世界的问题往往是复杂而多样的，需要综合不同学科的知识和技能来解决。例如，解决气候变化问题需要科学、工程、社会科学和政策制定等多个领域的专家共同努力。eg经济学和数学。
				- 让步，
				  collapsed:: true
					- 学科之间的合作可能存在困难和障碍：不同学科之间的语言、方法和文化差异可能导致合作困难。学科之间的合作需要耗费大量的时间和精力来克服这些障碍，这可能会降低进展的速度和效率。eg文学和机械就没什么关系mechanical engineering，literature
	  ...
	  collapsed:: true
		- Claim: While boredom is often expressed with a sense of self-satisfaction, it should really be a source of embarrassment.
		  ...
		  Reason: Boredom arises from a lack of imagination and self-motivation
			...
			- 反驳 reason：无聊可以由外部因素引起，而不仅仅是内部因素
			  collapsed:: true
			...
			- 但是决定去不去摆脱无聊的决定权在我们自己
			  collapsed:: true
				...
				- eg 一次无聊的会议，个体可以通过主动参与，提出问题，与其他与会者互动，或者寻找与会议主题相关的有趣观点来改变他们的体验。这种积极的参与和主动性可以被视为一种自我激励，因为个体通过自己的努力使情境更加有趣或有意义。
			- 确实是一种尴尬的源泉，而以自我满足的形式表示
			  collapsed:: true
				- 会议上的人可以找到有趣的点，而不这样做的人，没有勇气和自我激励，在 comfort zone 中不愿意走出去，是被动地，消极的，他们实际上知道自己的处境是尴尬的，但是却以一种批评的口吻和居高临下的角度来说是这个会议太过无聊，而不是说明自己没有改变的勇气和能力
	- 73，利他主义实际上是利己主义
	  collapsed:: true
		  ...
		  collapsed:: true
			- challenge your position
			  collapsed:: true
				...
				- 让步：指出，人们都可以犯错，丑闻不能掩盖功绩。总体来说，丑闻能揭露问题，从而促进改进
				  collapsed:: true
					- 有人可能说个人政治过分关注
			  ...
			  collapsed:: true
				- ways
				  collapsed:: true
					- 在城市和农村都有产生：
					  collapsed:: true
						- 城市通常是文化创新和新思想涌现的中心。密集的人口、各种教育和文化机构以及多元的社会组成，为新的文化形式的产生提供了肥沃的土壤。在城市中，人们更容易接触到不同的观念、艺术和娱乐形式，这促进了文化的不断更新和演变。
						- 然而，农村和小镇等地区同样承载着丰富的文化传统。
					- 在城市中的保留，有，但是减少了：
					  collapsed:: true
						- 有：城市也是博物馆、图书馆、剧院等文化机构的集中地，这些地方有助于保存和展示国家的文化遗产。
						- 减少：eg巴黎，全球化，文化在大城市中趋同
					- 在农村的保留：
					  collapsed:: true
						- 农村地区可能更深刻地保留了某些传统，因为在这些地方人们更紧密地与自然和传统生活方式相连。
	- 76，旧建筑还是现代建筑
	  collapsed:: true
	  ...
	  collapsed:: true
		- Some people believe that corporations have a responsibility to promote the well-being of the societies and environments in which they operate. Others believe that the only responsibility of corporations, provided they operate within the law, is to 
		  ...
		  make as much money as possible.
			- some社会责任： 许多人认为，公司不仅仅是为了盈利而存在，还有社会责任。它们应该通过雇佣当地人员、提供合理的工资和福利、支持社区项目等方式来回馈社会。
			  collapsed:: true
			...
			- some环保责任： 公司对环境的影响可以是巨大的，因此许多人认为公司有责任采取可持续的经营实践，减少对自然资源的消耗，降低碳足迹，遵守环境法规。
			  collapsed:: true
				- Patagonia这家户外服装公司以可持续发展和环保而闻名。他们致力于使用可回收材料制造产品，支持环境保护项目，并公开反对对环境有害的行业实践。
			- some与others联系，品牌声誉：关注社会和环境责任可以提高公司的声誉，吸引更多消费者和投资者。在今天的市场中，许多人更愿意支持那些对社会和环境问题负责的公司。
			  collapsed:: true
	...
	- 79，旅行和居住在许多地方or深刻理解当地增长一个人和别人联系的能力
	  collapsed:: true
	  ...
	  collapsed:: true
		- Claim: When one is making a decision, it is better to have a limited number of options. 
		  ...
		  Reason: The more options a person has, the more difficult it is to make a rational decision.
			- 反驳reason：
			  collapsed:: true
				- 有多的选项不代表你难做选择，如果你内心明确自己想要的东西，无论多少的选项总能选择出适合自己的。
				- eg购物选择。有一个人在购物时面临着多种品牌、款式和价格的选择。这个人可能通过在线比较和了解自己的偏好，最终从众多选项中挑选出最适合自己的商品。虽然有许多选择，但通过清晰的目标和了解，她成功地做出了理性的购物决定。
			- 反驳从reason到claim的推理：
			  collapsed:: true
				- 你的reason推不出来有更少的选项就更容易做合理的选择。选择是受多方面因素影响的，合理的选择可能更依赖于个体对于具体情境的深入考虑，而不仅仅取决于选项的数量。
				- eg某人在选择度假目的地时只有两个选项：沙滩度假胜地和山区度假胜地。尽管选项有限，但个人可能仍然面临选择困难，因为他可能面临各种因素，如天气、预算、兴趣等。因此，即使选项较少，仍然存在制约因素，使得决策并不一定更容易。
			- 多一个选择多一条路，自己选择的权利不被剥夺。选择的多，考虑的多，相互比较。
			  collapsed:: true
				- eg某人在职业发展中面临多个职位的选择。她收到了来自不同公司和领域的工作机会。由于有多个选择，她有机会更好地了解每个职位的优势和劣势。最终，她选择了一个与她个人兴趣和职业目标最相符的职位，这使她在职业生涯中更加满意。
	- 81，被迫分享信息和隐私受到侵蚀
	  collapsed:: true
		  ...
		  collapsed:: true
			- challenge your position.
			  collapsed:: true
				- 同意：
				  collapsed:: true
					- 首先，社交媒体的普及使得个人生活的大部分细节都成为公开信息。
					- 人们在平台上分享生活琐事、感受和照片，逐渐形成了一个无处不在的数字足迹。这无疑削弱了个人的隐私权，使得他们的个人生活对于他人变得更加透明。其次，大数据和个性化广告的崛起进一步强化了这一趋势。通过分析用户的在线行为和喜好，公司能够精准地定位广告和推荐内容。然而，这也意味着个人的喜好和习惯被广告商和平台广泛获取，可能导致滥用个人信息的风险。
				- 同意：客户信息被用于其他用途。
				  collapsed:: true
					- 一起涉及社交媒体平台Facebook的事件，Cambridge Analytica通过Facebook应用程序获取了数百万用户的个人信息，用于政治目的。这个丑闻揭示了在数字时代，社交媒体平台上的用户信息可能被滥用，引起了有关数据隐私和社交媒体责任的广泛辩论。
				- 敌方观点：尽管如此，一些人可能提出人们自愿分享信息，这并不违反隐私。
				  collapsed:: true
					- 都是用了网络强大的传播功能，互联网作为载体，比如说，博主网红直播带货。招聘网站，招聘工作的人，投简历，想让别人看到，赚钱，想让人找到他，建立联系。
- [[按公式拆分作文]]
- [[必备例子]]
- [[gre话题]]
-