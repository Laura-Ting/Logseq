...
- N应该做某事：做某事的影响（以结果论英雄）（30-22）1new
	...
	- Some people believe that college students should consider only their own talents and interests when choosing a field of study.
	  Others believe that college students should base their choice of a field of study on the availability of jobs in that field.
		...
		- 题型：
			- address both of the views
			- challenge your position-others
			  collapsed:: true
				- 承认：找到好就业（敌方观点）
				- 反驳，兴趣也应该考量，eg乔布斯or高斯，而且自己可能并不喜欢这个专业，排斥，不会长远，高等教育要培养人才而不只是工具人
				- 反驳：可行性，就业问题，热的更热冷的更冷。现在看好的专业之后可能就不那么受欢迎了。
	  ...
	  collapsed:: true
		- 模板：
			...
			- 科学家自己的创新观点得以实践：（科学家角度）
				- 比如说研究人员有很好的科研想法，但是政策不支持，就不说有没有资金，硬件条件，creative ideas 就没有实践条件，不愿意，更多人才，不能维持社会长期发展。
	...
	- Governments should not fund any scientific research whose consequences are unclear.
		- 模板：
			- 在资源有限的情况有好处
				- 有限的政府资源应当集中用于那些具有明确和直接利益的研究领域。资助那些具备清晰、实际利益的研究项目，有助于确保投入取得最大的社会回报。
				- 通过资助那些可以迅速转化为实际应用或解决社会问题的科研项目，政府能够更直接地促进社会发展和改善生活质量。
				- eg以色列是一个水资源紧缺的国家，但他通过投入资金研发和推广先进的灌溉系统和水资源管理技术，有效地应对了水资源紧缺的挑战。
			- 有时支持研究结果不明朗的领域有好处
				- 在COVID-19疫情初期，许多方面的研究都面临了很多未知。对于新兴病毒或罕见疾病，早期的研究通常面临挑战，因为科学家们需要从头开始了解病原体、传播方式、免疫反应等方面的信息。尽管研究初期结果可能并不明朗，但投入资源和资金以支持这些关键方向的研究是非常必要的，以便更好地理解新疾病并采取相应的措施。经过资金支持和科学家的不断努力，我们已经研制出了疫苗。
			- 但是有时结果不明朗（对社会产生危害的）不要支持加以限制，引出支持的都是什么
				- 政府可能希望避免支持那些可能带来未知风险或不确定后果的科研项目。这种谨慎的做法有助于减少潜在的负面影响，确保公共资源的合理使用。基因修改，生化武器滥用，会带来人类毁灭的风险
				- 引出需要支持的是造福于人民的。
		- 题型：
	  ...
	  Reason: Much of the information that people assume is factual actually turns out to be inaccurate.
		- 模板：
		  collapsed:: true
			...
			- 理性质疑而非盲目质疑：
			  id:: 65ad147b-4d18-44fe-bb80-87a2d087849d
	...
	- People who are the most deeply committed to an idea or policy are also the most critical of it.
		- 模板：
			- 和领域有关，和这个政策的影响与结果有关，不能一概而论
				- 科学研究领域：科学家的严谨性
				  collapsed:: true
					- 在任何一个例子中都要确保既有commitment又有criticality
